...
if __name__ == '__main__':
    ...
    parser.add_argument('-lp', '--leaderboard_data_path', type=str, default='/content/leaderboard/image')
    """
    Modify Path Below To Test Your Results
    """
    parser.add_argument('-yp', '--your_data_path', type=str, default='../result/VMC_Net/reconstructions_forward/')
